    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          ...
          <li class="breadcrumb-item"><a href="{{ route('training_center.detail', $news->center_id) }}">This Post Training Center</a></li>
              ...
              <div class="col-md-12">
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      <label>Content</label>
                      <textarea name="content" id="summernote"><p>{{ $news->content}}</p></textarea>
                      @error('content')
                      <span class="text-danger">{{ $message }}</span>
                      @enderror                    
                    </div>
