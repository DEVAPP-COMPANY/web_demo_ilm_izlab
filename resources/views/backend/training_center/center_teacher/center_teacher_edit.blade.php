    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          ...
          <li class="breadcrumb-item"><a href="{{ route('training_center.detail', $teacher->center_id) }}">This Teacher Training Center</a></li>
      ...
      <div class="col-md-12">
        ...
        <div class="card">
          ...
          <form method="POST" action="{{ route('teacher.update', $teacher->id) }}" enctype="multipart/form-data">
            @csrf
            <input type="hidden" name="old_image" value="{{ $teacher->avatar }}">
            <div class="card-body">
              <div class="col-md-12">
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="info_link" value="{{ $teacher->info_link }}" class="form-control" placeholder="https://t.me/abdullajon_soliyev">
                      @error('info_link')
                      <span class="text-danger">{{ $message }}</span>
                      @enderror
                    </div>
                    <div class="form-group">
                      ...
                      <input type="text" value="{{ $teacher->specialization }}" name="specialization" class="form-control" placeholder="Mobile Developer">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="text" value="{{ $teacher->experience }}" name="experience" class="form-control" placeholder="4 year">
                      @error('experience')
                      <span class="text-danger">{{ $message }}</span>
                      @enderror
                    </div>
