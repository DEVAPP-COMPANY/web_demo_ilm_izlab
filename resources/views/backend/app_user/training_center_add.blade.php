    ...
    <div class="row">
      ...
      <div class="col-md-12">
        ...
        <div class="card">
          ...
          <!-- /.card-header -->
          <!-- form start -->
          <form method="POST" action="{{ route('training_center.store') }}" enctype="multipart/form-data">
            @csrf
            <div class="card-body">
              <div class="col-md-12">
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      <label>Phone</label>
                      <input type="tel" name="phone" class="form-control" placeholder="+998994630613">
                      @error('phone')
                      <span class="text-danger">{{ $message }}</span>
                      @enderror
                    </div>
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <input type="number" name="monthly_payment_min" class="form-control">
                    ...
                    <div class="form-group">
                      ...
                      <input type="number" name="monthly_payment_max" class="form-control">
                    ...
                    <div class="form-group">
                      <label>Parol</label>
                      <input type="text" name="parol" class="form-control">
                      @error('parol')
                      <span class="text-danger">{{ $message }}</span>
                      @enderror                 
                    </div>
